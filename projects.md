...
<div class="section-wrapper">
  <section class="section project" id="project">
    <div id="project-text">
      ...
      <h3 class="heading-text justify-text"> Personal Website</h3>
      ...
      on the Contact page. </p><br>


  <h3 class="heading-text justify-text"> MSc Dissertation - Dark Halo Evolution in the Cosmic Web</h3>
